...
- **Issues**: [Report bugs or request features](https://github.com/detectaibugs/homebrew-claude-tap/issues)
...
```bash
brew tap detectaibugs/claude-tap && brew install detectaibugs && detectaibugs --setup-claude
```
