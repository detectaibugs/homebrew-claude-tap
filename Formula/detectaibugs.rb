class Detectaibugs < Formula
  ...
  homepage "https://github.com/discoveraibugs/homebrew-claude-tap"
  version "2.0.1"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/discoveraibugs/homebrew-claude-tap/releases/download/v2.0.1/detectaibugs-darwin-arm64.tar.gz"
      sha256 "340fb201753fe4326a1b634855452c5a2b055d13d0ed31bb7248415017241365"
    else
      url "https://github.com/discoveraibugs/homebrew-claude-tap/releases/download/v2.0.1/detectaibugs-darwin-amd64.tar.gz"
