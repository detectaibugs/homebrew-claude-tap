...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.5"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.5/detectaibugs-darwin-arm64.tar.gz"
    sha256 "6e4bca7522570bf7ce6105724852bd3be9c1bbdd0b2d673be710368151a775e5"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.5/detectaibugs-darwin-amd64.tar.gz"
