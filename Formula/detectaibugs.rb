...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.7"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.7/detectaibugs-darwin-arm64.tar.gz"
    sha256 "edcff62e383d33072eb8d5ea8f1ced791cb0c4498ca0a9c4a3e90898ba8cd456"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.7/detectaibugs-darwin-amd64.tar.gz"
