...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.3"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.3/detectaibugs-darwin-arm64.tar.gz"
    sha256 "18f131734cceff1b5cea20d06f185eb84733a93f379c87e81f15e62b2fa8d568"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.3/detectaibugs-darwin-amd64.tar.gz"
