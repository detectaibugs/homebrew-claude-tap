...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/vTEST"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/vTEST/detectaibugs-darwin-arm64.tar.gz"
    sha256 "833dad67c4b1aab0d2cacc5a518ae56f1a39475c91f55034910e54733b099a2f"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/vTEST/detectaibugs-darwin-amd64.tar.gz"
