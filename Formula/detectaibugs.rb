class Detectaibugs < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/discoveraibugs/homebrew-claude-tap/releases/download/v2.0.0/detectaibugs-darwin-arm64.tar.gz"
      sha256 "7e421f13d037f678b2fd82c3e3174a7a28b8c7a26812bfb6cb2695b9a9902232"
    else
      url "https://github.com/discoveraibugs/homebrew-claude-tap/releases/download/v2.0.0/detectaibugs-darwin-amd64.tar.gz"
