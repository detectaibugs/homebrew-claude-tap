...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.5"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.5/detectaibugs-darwin-arm64.tar.gz"
    sha256 "b8aff4874f05a67ede331e439fba105bf3c39ac475ab4d4bdf42e3940c889a70"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.5/detectaibugs-darwin-amd64.tar.gz"
