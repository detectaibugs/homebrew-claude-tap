...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.2"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.2/detectaibugs-darwin-arm64.tar.gz"
    sha256 "a9ac94ea9caec2e45e8b018511512badb62c2bb5b5294be240534b6109c2199a"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.2/detectaibugs-darwin-amd64.tar.gz"
