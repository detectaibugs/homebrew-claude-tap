...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.6"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.6/detectaibugs-darwin-arm64.tar.gz"
    sha256 "a67cb66de12ae07785fad7e375ee0efd064b54b23262b64b15aea791dbfb2e02"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.6/detectaibugs-darwin-amd64.tar.gz"
