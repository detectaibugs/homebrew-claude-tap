...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.4"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.4/detectaibugs-darwin-arm64.tar.gz"
    sha256 "73bfe451c2bfaf1e92f0657e55bdf81b17ba6b01bb92ab29cf819b3755afdef8"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.0.4/detectaibugs-darwin-amd64.tar.gz"
