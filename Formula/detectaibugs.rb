...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/vTEST2"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/vTEST2/detectaibugs-darwin-arm64.tar.gz"
    sha256 "918ecac370493c453382f72264c8041213ae53c26841230253ec75de5765bbb9"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/vTEST2/detectaibugs-darwin-amd64.tar.gz"
