...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.4"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.4/detectaibugs-darwin-arm64.tar.gz"
    sha256 "ba38aac5af1051d9cbabdbc266a3e17b9a4956adbb91b000c481df414fcd3d71"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/v2.1.4/detectaibugs-darwin-amd64.tar.gz"
