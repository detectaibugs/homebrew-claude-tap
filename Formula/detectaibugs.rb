...
class Detectaibugs < Formula
  ...
  bottle do
    root_url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/vTEST3"
  ...
  on_arm do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/vTEST3/detectaibugs-darwin-arm64.tar.gz"
    sha256 "494a363b7bb163eb12b80f94bd7df697a3367bad4d238b4ece4e56de26f412ae"
  end

  on_intel do
    url "https://github.com/detectaibugs/homebrew-claude-tap/releases/download/vTEST3/detectaibugs-darwin-amd64.tar.gz"
