# 🎉 DetectAIBugs v2.0 - Now with Claude Code Support!

> **⚡ Major Upgrade:** DetectAIBugs v2.0 is a complete rewrite in Go, bringing massive performance improvements, better security, and seamless integration with Claude Code!
>
> **📅 Released:** November 17, 2025

Official Homebrew tap for **DetectAIBugs CLI** - AI-powered code analysis tool for Claude Code users.
...
brew tap discoveraibugs/claude-tap
...
Run DetectAIBugs directly in any Claude Code session:
...
That's it! DetectAIBugs will analyze your code, detect bugs, and provide actionable feedback through Claude.

---

## ✨ Features

- **🤖 AI-Powered Analysis** - Leverages Claude's intelligence with custom detection logic
...
detectaibugs reinstall-claude-action
...
- **Issues**: [Report bugs or request features](https://github.com/discoveraibugs/homebrew-claude-tap/issues)
...
```bash
brew tap discoveraibugs/claude-tap && brew install detectaibugs
```
